...
str=["ground","DC votage","DC votage","current source","AC source","resistor","resistor","inductor","capacitor","diode","ground",'blank','wire']
for i in xrange(26-len(str)):
    str.append('unreconized')
acu=[]
print len(str)
